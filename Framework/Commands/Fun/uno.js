    ...
    async execute(msg, args) {
        ...
        async function startGame(players) {
            ...
            var playEmb = new Discord.MessageEmbed()
                .setTitle("Uno")
                .setColor(config.embedColor)
                .setDescription("Click <:uno:728436977426497556> to call uno on someone! If you're about to play your second to last card, or already have one card, you can click <:uno:728436977426497556> to declare uno")
